...
public class Constants {
	...
	//HAZARD
	public static String HAZARD_MESSAGE = "Ok, I'm trying to turn on the hazard light, please wait a second";
	
	public static String HAZARD_HELP_MESSAGE = "You can say turn on the hazard light";
	
	//HORN
	public static String HORN_MESSAGE = "Ok, I'm trying to honk the horn, please wait a second";
